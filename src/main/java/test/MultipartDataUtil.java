...
public class MultipartDataUtil {
    ...
    public static void postMultipartData(ChannelHandlerContext ctx) throws IOException {
//        String uri = "/LAPI/V1.0/PACS/GUI/PicFile?Type=2";
        ...
        postMultipartData(ctx,uri,fliedMap,fileParts);
    }


    public static void postMultipartData(ChannelHandlerContext ctx, String uri, Map<String,String> fliedMap, ArrayList<FilePart> fileParts) throws IOException {
        // 分隔符
        String BOUNDARY = "--------------------------328804715201393196989403";
        // 远程ip与port
        InetSocketAddress ipSocket = ((SocketChannel)ctx.channel()).remoteAddress();
